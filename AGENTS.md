...
- `src/App.tsx`: React orchestration, draft/import state, playback and narration synchronization, current-snapshot selection, editing callbacks, the two-page side panel (Script / Setup), controls, and present mode.
